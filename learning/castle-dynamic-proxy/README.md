...
A few points regarding Dynamic Proxy that would be useful to keep in mind:
...
- It not allows you to intercept `System.Object`’s (or `System.MarshalByRefObject`’s) methods, unless they’re overridden in the proxy type (or in any of its base types)
- It can not intercept non-virtual calls
